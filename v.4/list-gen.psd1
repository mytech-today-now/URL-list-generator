@{
    ...
    # Version: 3.2.0 (Output format support, enhanced CLI, quality improvements)
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = @'
## v3.2.0 - Output Format Support & CLI Enhancements
- **Added**: CLI output format support (Text, JSON, CSV) via `-OutputFormat` and `-OutputFile` parameters
- **Enhanced**: Result export functionality with structured output for automation/integration
- **Improved**: PSScriptAnalyzer suppressions using proper PowerShell comment syntax (fixes ParserError)
- **Added**: Environment variable documentation for all configurable settings
- **Enhanced**: Comprehensive parameter validation and help examples for new features
- **Fixed**: Module version updated to 3.2.0 across all files
- **Improved**: Cross-platform path handling refinements
...
- **Enhanced**: Error logging now correctly passes `Exception` objects
